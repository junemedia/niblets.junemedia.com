...
include_once("$sGblIncludePath/otPageInclude.php");
...
if (isset($sPhone_areaCode) && isset($sPhone_areaCode) && isset($sPhone_areaCode)) {
...
if ($sSalutation != '') { $_SESSION["sSesSalutation"] = $sSalutation; }
if ($sFirst != '') { $_SESSION["sSesFirst"] = $sFirst; }
if ($sLast != '') { $_SESSION["sSesLast"] = $sLast; }
if ($sEmail != '') { $_SESSION["sSesEmail"] = $sEmail; }
if ($sAddress != '') { $_SESSION["sSesAddress"] = $sAddress; }
if ($sAddress2 != '') { $_SESSION["sSesAddress2"] = $sAddress2; }
if ($sCity != '') { $_SESSION["sSesCity"] = $sCity; }
if ($sState != '') {
...
if ($sPhoneNoDash != '') { $_SESSION['sSesPhoneNoDash'] = $sPhoneNoDash; }
if ($sPhone_ext != '') { $_SESSION['sSesPhoneExt'] = $sPhone_ext; }
...
if ( (count($_SESSION['aSesOffersTaken']) > 0 || count($_SESSION["aSesPage2Offers"]) > count($aDropOffers) ) ) {
	if ( !(validateEmailFormat($_SESSION['sSesEmail'])) ) {
		$bUserDataIsSet=false;
		$sUserDataMessage .= "<li>Please Enter A Valid Email Address...";
		$_SESSION["sSesEmailAsterisk"] = "<font color=red>*</font> ";
	}

	if ( !(validateName($_SESSION['sSesFirst']))) {
		$bUserDataIsSet=false;
		$sUserDataMessage .= "<li>Please Enter A Valid First Name...";
		$_SESSION["sSesFirstNameAsterisk"] = "<font color=red>*</font> ";
	}

	if ( !(validateName($_SESSION['sSesLast']))) {
		$bUserDataIsSet=false;
		$sUserDataMessage .= "<li>Please Enter A Valid Last Name...";
	...
	if( substr( $sAoValidation, 0, 7 ) == "Failure" ) {
		...
		switch ( $sAoErrorCode ) {
			case 'AM':
				$sUserDataMessage .= "<li>$sAoErrorText Contains Invalid Characters or Are Blank";
				...
				break;
			case 'R':
				$sUserDataMessage .= "<li>Please Enter a Valid Address for your Street";
				$_SESSION["sSesAddressAsterisk"] = "<font color=red>*</font> ";
				$_SESSION["sSesCityAsterisk"] = "<font color=red>*</font> ";
				$_SESSION["sSesStateAsterisk"] = "<font color=red>*</font> ";
				$_SESSION["sSesZipCodeAsterisk"] = "<font color=red>*</font> ";
				break;
			case 'U':
				$sUserDataMessage .= "<li>Please Enter a Valid Street for your City, State, and ZipCode";
				$_SESSION["sSesAddressAsterisk"] = "<font color=red>*</font> ";
				$_SESSION["sSesCityAsterisk"] = "<font color=red>*</font> ";
				$_SESSION["sSesStateAsterisk"] = "<font color=red>*</font> ";
				$_SESSION["sSesZipCodeAsterisk"] = "<font color=red>*</font> ";
				break;
			case 'X':
				$sUserDataMessage .= "<li>Please Enter a Deliverable Address";
				$_SESSION["sSesAddressAsterisk"] = "<font color=red>*</font> ";
				$_SESSION["sSesCityAsterisk"] = "<font color=red>*</font> ";
				$_SESSION["sSesStateAsterisk"] = "<font color=red>*</font> ";
				$_SESSION["sSesZipCodeAsterisk"] = "<font color=red>*</font> ";
				break;
			case 'T':
				$sUserDataMessage .= "<li>Please Check the Format of Your Address";
				$_SESSION["sSesAddressAsterisk"] = "<font color=red>*</font> ";
				$_SESSION["sSesCityAsterisk"] = "<font color=red>*</font> ";
				$_SESSION["sSesStateAsterisk"] = "<font color=red>*</font> ";
				$_SESSION["sSesZipCodeAsterisk"] = "<font color=red>*</font> ";
				break;
			case 'Z':
				$sUserDataMessage .= "<li>Please Enter a Valid Zip Code";
				$_SESSION["sSesAddressAsterisk"] = "<font color=red>*</font> ";
				$_SESSION["sSesCityAsterisk"] = "<font color=red>*</font> ";
				$_SESSION["sSesStateAsterisk"] = "<font color=red>*</font> ";
				$_SESSION["sSesZipCodeAsterisk"] = "<font color=red>*</font> ";
				break;
			case 'W':
				$sUserDataMessage .= "<li>Address Failure: Early Waring Address.  Please correct.";
				$_SESSION["sSesAddressAsterisk"] = "<font color=red>*</font> ";
				$_SESSION["sSesCityAsterisk"] = "<font color=red>*</font> ";
				$_SESSION["sSesStateAsterisk"] = "<font color=red>*</font> ";
				$_SESSION["sSesZipCodeAsterisk"] = "<font color=red>*</font> ";
	...
	if (dbNumRows($sCheckPhoneResult) == 0 ) {
		...
		if ( strlen($_SESSION['sSesPhone']) ==0 ) {
			...
			$bPhoneIsSet=false;
			$sUserDataMessage .= "<li>Phone Number You Entered Is Not A Valid Phone Number...";
			$_SESSION["sSesPhoneNoAsterisk"] = "<font color=red>*</font> ";
		} else if (  $iPhoneZipDistance > 250) {
			exceedsMaxDistance($_SESSION['sSesPhone'], $_SESSION['sSesZip'], 250);
			$bPhoneIsSet=false;
			$sUserDataMessage .= "<li>Phone Number Is Not Valid For The Zipcode You Entered...";
			$_SESSION["sSesZipCodeAsterisk"] = "<font color=red>*</font> ";
			$_SESSION["sSesPhoneNoAsterisk"] = "<font color=red>*</font> ";
		} else if ($_SESSION['sSesPhoneExt'] != '' && !(isInteger($_SESSION['sSesPhoneExt']))) {
			$bPhoneIsSet=false;
			$sUserDataMessage .= "<li>Phone Number Extension Is Not Valid...";
			$_SESSION["sSesPhoneNoAsterisk"] = "<font color=red>*</font> ";
		}
	}
...
$sNoBounceCheckQuery = "SELECT noBounceChecks FROM   links WHERE sourceCode = '" . $_SESSION["sSesSourceCode"] . "' AND noBounceChecks = 1;";
	...
	if (count($_SESSION['aSesOffersTaken']) > 0) {
		...
		if ( dbNumRows($rActiveCheckResult) == 0 ) {
			...
			if (!($rInsertResult)) {
				...
				mail('it@amperemedia.com',"Insert userData Failed - newOtPage2Submit.php", "$sEmailMessage");
			}
			echo dbError();
		} else {
...
if( !$bGlobalJoinInsertDisable ) {
	...
	// For each offer in the session's list of offers that have been taken:
	// Process them.
		...
		if(dbNumRows($rOfferIsCoRegResult)){
			if ($bFoundDuplicateLead == false) {
				...
				if (!($rLeadInsertResult)) {
					...
					mail('it@amperemedia.com',"Insert otData Failed - newOtPage2Submit.php", "$sEmailMessage");
				}
			}
		}
