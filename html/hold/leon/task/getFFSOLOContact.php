...
$r = mysql_query($sql);
$filename = CAMPAIGNER_LEON_ROOT . "export/isFFSolo.csv";
...
echo exec("zip " . CAMPAIGNER_LEON_ROOT . "export/isFFSOLO." . date("YmdHms") . ".csv.zip " . CAMPAIGNER_LEON_ROOT . "export/isFFSolo.csv") . "\n\r";

if(MAIL_RESULT){
    $email = "leonz@junemedia.com,williamg@junemedia.com";
    $title = "IsFFSOLO email dump for " . date("Y-m-d H:m:s");
    $context = "Leon FFSOLO export file";
