                  ...
                  <version major="2" minor="0" build="0" revision="0" />
                            ...
                            <group>
								...
								<filter>
									<relation>And</relation>
                                    <filtertype>SearchAttributeValue</filtertype>
                                    <contactattributeid>4195798</contactattributeid>
                                    <action>
                                        <type>Boolean</type>
								...
								<filter>
									<relation>And</relation>
                                    <filtertype>SearchAttributeValue</filtertype>
                                    <contactattributeid>4195818</contactattributeid>
                                    <action>
                                        <type>Boolean</type>
                                        <operator>NotEqualTo</operator>
                                        <value>1</value>
								...
								<filter>
									<relation>And</relation>
                                    <filtertype>SearchAttributeValue</filtertype>
                                    <contactattributeid>4195808</contactattributeid>
                                    <action>
                                        <type>Boolean</type>
                                        <operator>NotEqualTo</operator>
                                        <value>1</value>
								...
								<filter>
									<relation>And</relation>
                                    <filtertype>SearchAttributeValue</filtertype>
                                    <contactattributeid>4195828</contactattributeid>
                                    <action>
                                        <type>Boolean</type>
                                        <operator>NotEqualTo</operator>
                                        <value>1</value>
