...
function myFreePopup() {
	...
	//**** DO NOT CHANGE ANYTHING IN FOLLOWING COMMENT LINE ****/
	
	//*** START SPECIFY POPUP ARRAYS ***//
	
	var popUpArray = new Array ('AMP9992', 'AMP9999', 'AMP9995', 'YFP9992', 'AMP9994', 'AMP9998', 'AMP9991', 'FSW9999');
	
	var popUpUrlArray = new Array("http://www.popularliving.com/pops/AMP9992.php",
	"http://www.popularliving.com/pops/AMP9999.php",
	"http://www.popularliving.com/pops/AMP9995.php",
	"http://www.popularliving.com/pops/YFP9992.php",
	"http://www.popularliving.com/pops/AMP9994.php",
	"http://www.popularliving.com/pops/AMP9998.php",
	"http://www.popularliving.com/pops/AMP9991.php",
	"http://www.popularliving.com/pops/FSW9999.php");
	
	
	//*** END SPECIFY POPUP ARRAYS ***//
	
	//**** DO NOT CHANGE ANYTHING IN PREVIOUS COMMENT LINE ****/
	...
	if ( lastPopUpDate ) {
		...
		if (dateDifference >= daysBetweenPopups)
		{
			...
			if (tempPopUpArray.length > 0 ) {
				...
				popUpUrlArray = tempPipUpUrlArray;											
			}
