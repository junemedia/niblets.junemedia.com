...
$ProgramDropDown = '';
	if ($iId == '2') {
	$sProgramDropDown = "<option value='' selected='selected'> Please choose an area of study</option>
...
if ($iId == '45') {
	$sProgramDropDown = "<option value='' selected='selected'> Please choose an area of study</option><br>
