...
$sPageTitle = "MyHealthyLiving Web Site Vars - Add/Edit Var";
...
if (($sSaveClose || $sSaveNew) && !($id)) {
	...
	$addQuery = "INSERT INTO var(varName, varInternalName, varText)
...
<table cellpadding=5 cellspacing=5 bgcolor=c9c9c9 width=95% align=center>
	...
	<tr><td>Variable Text</td>
		<td><input type=text name='varText' value='<?php echo $varText;?>'></td>
	</tr>
