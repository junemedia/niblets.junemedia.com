			...
			if (!($iId)) {
				...
				if (dbNumRows($rCheckResult) == 0) {
					...
					$sInsertQuery = "INSERT INTO offers(offerCode, companyId, partnerId, name, headline,
							...
							mode, isLive, activeDateTime, inactiveDateTime, page2Template, page2JavaScript, isCap, defaultSortOrder) 
					 	VALUES('$sOfferCode', '$iCompanyId', '$iPartnerId', \"$sName\", \"$sHeadline\", \"$sDescription\", '$iIsNonRevenue', '$fRevPerLead',
								...
								'$iPage2Info', '$sMode', '$iIsLive', '$sActiveDateTime', '$sInactiveDateTime', \"$sPage2Template\", \"$sPage2JavaScript\", '$iIsCap', '$iDefaultSortOrder')";
