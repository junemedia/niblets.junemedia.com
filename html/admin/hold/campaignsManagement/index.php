...
if (hasAccessRight($iMenuId) || isAdmin()) {
	...
	while ($oRow = dbFetchObject($rSelectResult)) {
		...
		$sList .= "<tr class=$sBgcolorClass><td>$oRow->campaignName</td>
						...
						<a href='campaignHeaders.php?iMenuId=$iMenuId&campaignId=".$oRow->id."'>Manage Campaign Headers</a>
						
						| <a href='campaignText.php?iMenuId=$iMenuId&campaignId=".$oRow->id."'>Manage Campaign Text</a>
...
<tr><td class=header>Campaign Name</td><td class=header>Description</td></tr>
<?php echo $sList;?>
<tr><td colspan=5 align=left><?php echo $sAddButton;?></td></tr>
</table>
</form>
