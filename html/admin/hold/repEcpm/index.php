...
<tr><td>Date From</td><td><select name=iMonthFrom><?php echo $sMonthFromOptions;?>
	...
	<tr><td></td>
		<td colspan=3><input type=checkbox name=iGrossLeads value='1' <?php echo $sGrossLeadsChecked;?>> Gross Leads
		&nbsp;&nbsp;<input type=checkbox name=iExcludeApiLeads value='1' checked> Exclude API Leads
		&nbsp;&nbsp;<input type=checkbox name=iActivePagesOnly value='1' checked> Active Pages Only
		</td></tr>
	<tr><td>Show Only</td>
	...
	&nbsp; &nbsp; <input type=button name=sSubmit value='Export Report' onClick="funcReportClicked('export');">	
...
<tr><td colspan=4>Active Pages Only:  Leads collected from that page within last 30 days OR no leads collected within 30 days and the page was created within last 30 days.</td></tr>
</table>
