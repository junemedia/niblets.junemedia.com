...
while ($link_row = mysql_fetch_object($get_links_result)) {
	...
	$data .= "<tr bgcolor=$sBgcolorClass>
			<td><a href='/admin/ff_flow2.0/addEdit.php?linkid=$link_row->linkid'>$link_row->name</a></td>
			<td><a href='/admin/ff_flow2.0/addEditSubcampId.php?linkid=$link_row->linkid'>Add/Edit</a></td>
...
$fp = fopen('/var/www/html/admin.popularliving.com/html/admin/ff_flow2.0/export.csv', 'w');
fwrite($fp, $export);
fclose($fp);
...
<html>
<head>
<title>F&F Links Management</title>
<style>
...
<body>
<center>
<h3><b>FitandFabLiving Links Management</b></h3>
<a href="/admin/ff_flow2.0/addEdit.php"><b>Create New Link</b></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="/admin/ff_flow2.0/addNewSource.php" onclick="javascript:void window.open('/admin/ff_flow2.0/addNewSource.php','1373923368168','width=500,height=500,toolbar=0,menubar=0,location=0,status=0,scrollbars=1,resizable=1,left=100,top=100');return false;"><b>Source Management</b></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="/admin/ff_flow2.0/addNewCampaign.php" onclick="javascript:void window.open('/admin/ff_flow2.0/addNewCampaign.php','1373923368168','width=500,height=500,toolbar=0,menubar=0,location=0,status=0,scrollbars=1,resizable=1,left=100,top=100');return false;"><b>Campaign Management</b></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="/admin/ff_flow2.0/addNewSubcampid.php" onclick="javascript:void window.open('/admin/ff_flow2.0/addNewSubcampid.php','1373923368168','width=500,height=500,toolbar=0,menubar=0,location=0,status=0,scrollbars=1,resizable=1,left=100,top=100');return false;"><b>SubcampID Management</b></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="/admin/ff_flow2.0/addNewTemplate.php" onclick="javascript:void window.open('/admin/ff_flow2.0/addNewTemplate.php','1373923368168','width=500,height=600,toolbar=0,menubar=0,location=0,status=0,scrollbars=1,resizable=1,left=100,top=100');return false;" style="color:red;"><b>Template Management (IT only)</b></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="/admin/ff_flow2.0/report.php"><b>Report</b></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="export.csv" target="_blank"><b>Download/Export Below Links</b></a>
<br><br>
<font color="Red">Once links are created (before going live), you MUST assign subcampid using Add/Edit option otherwise all signup will go under default (3588) subcampid.</font>
<br><br>
...
- Reporting data not available before Nov 11th, 2013.<br>
</body>
</html>