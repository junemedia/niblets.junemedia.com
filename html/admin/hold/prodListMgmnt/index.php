...
if (hasAccessRight($iMenuId) || isAdmin()) {
	...
	$sSelectQuery = "SELECT *
					...
					AND requestType not like '%campaign%'
	...
	$sProductionList .= "<tr><td colspan=7 class=header><BR>New Campaign/Changes to Campaign Requests</td></tr>";
	$sSelectQuery13 = "SELECT * FROM   productionList
					WHERE requestType IN ('New Campaign','Changes To Existing Campaign')
					AND (status = 'scheduled' || status = 'unknownSchedule' || status = 'newRequest')
					ORDER BY $sOrderColumn $sCurrOrder ";
