...
$sPageTitle = "FunPage Referrer messages";

session_start();

if (hasAccessRight($iMenuId) || isAdmin()) {
	
	$logfile = "$sGblFpWebRoot/refer/referrer.txt";	
...
$referrerLog .= "</center>";
	...
	$clearButton = "<input type=button name=clear value='Clear Log' onClick='JavaScript:void(confirmDelete());'>";
