...
Script to Display TAF Report of HandCraftersVillage site

*************/

include("../../../includes/paths.php");

$sPageTitle = "Handcrafters Village TAF Report";
...
if (hasAccessRight($iMenuId) || isAdmin()) {
	...
	$sTempQuery = "\n$TAFQuery";
		$TAFResult = dbQuery($TAFQuery);
		
	while ($TAFRow = dbFetchObject($TAFResult)) {
			$grandTotalTAFCount += $TAFRow->counts;
		}
				
	$countQuery .= " SELECT clickDate, counts 
					 FROM   TAFCounts 
					 WHERE  clickDate BETWEEN '$dateFrom' AND '$dateTo'
					 ";
	...
	$sAddQuery = "INSERT INTO nibbles.trackNibbleUse(userName, pageName, dateTimeLogged, action)
			  VALUES('$sTrackingUser', '$PHP_SELF', now(), \"View Report: $sTempQuery\")";
	...
	while ($countRow = dbFetchObject($countResult)) {
		...
		$TAFCounts = $countRow->counts;
		$totalTAFCounts += $TAFCounts;
		...
		$reportData .= "<tr class=$bgcolorClass><td>$clickDate</td><td>$TAFCounts</td></tr>";		
	}
	
	if (dbNumRows($countResult) >0) {
		$reportData .= "<tr><td align=right class=header>Page Total Count &nbsp; &nbsp; </td><td>$totalTAFCounts</td></tr>
						<tr><td align=right class=header>Grand Total Count &nbsp; &nbsp; </td><td>$grandTotalTAFCounts</td></tr>";
	}
	...
	$reportLinks = "<a href='catDisplayReport.php?iMenuId=$iMenuId&iParentMenuId=$iParentMenuId&sParentMenuFolder=$sParentMenuFolder'>Category Report</a>
					&nbsp; &nbsp;<a href='proDisplayReport.php?iMenuId=$iMenuId&iParentMenuId=$iParentMenuId&sParentMenuFolder=$sParentMenuFolder'>Project Report</a>";
...
<table cellpadding=5 cellspacing=0 bgcolor=c9c9c9 width=95% align=center>
<tr><td colspan=2 align=right class=header><?php echo $firstPageLink;?> &nbsp; <?php echo $prevPageLink;?> &nbsp; <?php echo $nextPageLink;?> &nbsp; <?php echo $lastPageLink;?> &nbsp; <?php echo $currentPage;?></td></tr>
	<tr><td class=header>Click Date</a></td>	
	<td class=header>TAF Counts</td></tr>
<?php echo $reportData;?>	
<tr><td colspan=2 align=right class=header><?php echo $firstPageLink;?> &nbsp; <?php echo $prevPageLink;?> &nbsp; <?php echo $nextPageLink;?> &nbsp; <?php echo $lastPageLink;?> &nbsp; <?php echo $currentPage;?></td></tr>
</table>
</form>
