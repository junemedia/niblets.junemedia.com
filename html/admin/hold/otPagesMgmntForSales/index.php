...
<tr><td colspan=8><?php echo $sAddButton;?></td>	
</tr>

<tr><td>Filter By</td><td colspan=7><input type=text name=sFilter value='<?php echo $sFilter;?>'> &nbsp; 
	<input type=checkbox name=iExactMatch value='Y' <?php echo $sExactMatchChecked;?>> Exact Match</td></tr>	

<tr><td>Exclude</td><td colspan=7><input type=text name=sExclude value='<?php echo $sExclude;?>'></tR>
<tr><td>Search In</td><td><select name=sSearchIn>
	<?php echo $sSearchInOptions;?>
	</select></td><td colspan=6><input type=submit name=sViewOffers value='Query'></td></tr>
