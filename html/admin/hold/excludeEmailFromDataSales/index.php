...
if (hasAccessRight($iMenuId) || isAdmin()) {
	...
	if ($sDelete) {
		...
		$sDeleteQuery = "DELETE FROM excludeEmailDataSales
	 			   		WHERE  id = $iId"; 
	...
	// Select Query to display list banned email
	...
	while ($oRow = dbFetchObject($rSelectResult)) {
		...
		$sExcludedEmailList .= "<tr class=$sBgcolorClass><TD>$oRow->email</td><TD>$oRow->userName</td>
...
<tr><td class=header>Excluded Emails From Data Sales</td>
<td class=header>Account Executive</td>
</tr>

<?php echo $sExcludedEmailList;?>
<tr><td colspan=7 align=left><?php echo $sAddButton;?></td></tr>
</table>
