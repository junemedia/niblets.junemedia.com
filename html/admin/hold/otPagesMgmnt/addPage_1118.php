	...
	if ( $iCheckRedirectTo && !remoteFileExists($sRedirectTo)) {
		...
		if (!($iId)) {
			...
			if (dbNumRows($rCheckResult) == 0) {
				...
				$sAddQuery = "INSERT INTO otPages(pageName, title, notes, pageLayoutId, page2LayoutId, userFormLayoutId, e1PageLayoutId, hiddenForm, minNoOfOffers, maxNoOfOffers, displayYesNo, offerImageSize, offerFontSize,
					 ...
					 VALUES('$sPageName', \"$sTitle\", \"$sNotes\", '$iPageLayoutId', '$iPage2LayoutId', '$iUserFormLayoutId', '$iE1PageLayoutId', '$iHiddenForm', '$iMinNoOfOffers', '$iMaxNoOfOffers', '$iDisplayYesNo', '$sOfferImageSize', '$sOfferFontSize',
