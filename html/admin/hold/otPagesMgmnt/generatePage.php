...
$sOtPageSubmitFile = "/otPageSubmit.php";
$sOtPage2SubmitFile = "/otPage2Submit.php";
...
$sOtPageQuery = "SELECT *
				 FROM   otPages
				 WHERE  pageName != 'sop'  
				 AND pageName != 'firePixelAndRedirect'";
...
$sLogAddQuery = "INSERT INTO nibbles.trackNibbleUse(userName, pageName, dateTimeLogged, action) 
  VALUES('$sTrackingUser', '$PHP_SELF', now(), \"Regenerate OT pages: $sOtPageQuery\")"; 
...
if ($iDisplayPoweredBy) {
	$sOtPageContent = ereg_replace("\[POWERED_BY\]", "<img src='/images/poweredBy.gif'>", $sOtPageContent);
} else {
...
if (\$sSiteId != '') {\n
	...
	while (list(\$key,\$val) = each(\$aGblSites)) {\n
		...
		fwrite($rOtPageFile, " \n include(\"../includes/otPageInclude.php\");\n");
		fwrite($rOtPageFile, " \n include(\"../includes/otPageOffers.php\");?>\n");
		fwrite($rOtPageFile, $sOtPageContent);
		fwrite($rOtPageFile, " \n <?php \n include(\"../includes/otPage1BottomInclude.php\");?>\n");
		fclose($rOtPageFile);
	}
...
$sPage2Template = ereg_replace("\[ACTION\]","/otPage2Submit.php", $sPage2Template);
...
include(\"../includes/otPageInclude.php\");\n
include(\"../includes/otPage2Offers.php\");\n
...
\$aPathInfo = explode(\"/\",\$_SERVER['PHP_SELF']);\n
								   ...
								   \$sPageName = substr(\$sFileName,0,strlen(\$sFileName)-7);\n
									...
									\$_SESSION[\"iSesPageId\"] = \$iPageId;\n
include(\"../includes/e1PageInclude.php\");?>\n". $sE1PageContent."\n";
