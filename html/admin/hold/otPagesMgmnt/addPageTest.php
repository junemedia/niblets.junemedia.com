	...
	if ($sPageName == '') {
		...
		if (!($iId)) {
			...
			if (dbNumRows($rCheckResult) == 0) {
				...
				$sAddQuery = "INSERT INTO otPages(id, pageName, title, notes, pageLayoutId, page2LayoutId, newPage2LayoutId, userFormLayoutId, newUserFormLayoutId, offerListLayoutId, e1PageLayoutId, hiddenForm, minNoOfOffers, maxNoOfOffers, displayYesNo, offerImageSize, offerFontSize,
							...
							defaultAutoRespId, isCobrand, displayPoweredBy, offerNotRequired, optOut, sureOptOut, sureOptOutText, noThankYouCode,
					 ...
					 VALUES('$iNewId', '$sPageName', \"$sTitle\", \"$sNotes\", '$iPageLayoutId', '$iPage2LayoutId', '$iNewPage2LayoutId', '$iUserFormLayoutId', '$iNewUserFormLayoutId', '$iOfferListLayoutId', '$iE1PageLayoutId', '$iHiddenForm', '$iMinNoOfOffers', '$iMaxNoOfOffers', '$iDisplayYesNo', '$sOfferImageSize', '$sOfferFontSize',
							...
							'$iIsCobrand', '$iDisplayPoweredBy', '$iOfferNotRequired', '$iOptOut', '$iSureOptOut', \"$sSureOptOutText\", \"$sNoThankYouCode\", 
							...
							'$iDisplayShoppingSpreeDisclaimer', '$iDisplayShoppingSpreeDisclaimerWithPPLink', '$sShowExitPopup', \"$sSrcForExitPopup\")";
