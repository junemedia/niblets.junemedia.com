...
$sOtPageSubmitFile = "/newOtPageSubmit.php";
$sOtPage2SubmitFile = "/newOtPage2Submit.php";
...
$sLogAddQuery = "INSERT INTO nibbles.trackNibbleUse(userName, pageName, dateTimeLogged, action) 
  VALUES('$sTrackingUser', '$PHP_SELF', now(), \"Regenerate B pages: $sOtPageQuery\")"; 
...
// a possibly missing var: $sGblDisplayPageImagesUrl
...
if (strstr($sOtPageContent, "[ASP_FILE]")) {
	...
	$sNewVarString = "<?php
					if (\$PMID !='') {
						...
						echo \"<img src = \\\"$sGblDisplayPageImagesUrl/$sPageName/images/".$sHeaderGraphicFile."\\\" border=0>\";
					}\n?>";
...
if ($bOtPagesDir) {
	...
	unlink($sPageName."b.php");
	$rOtPageFile = fopen($sPageName."b.php", "w");
...
if (\$sSiteId != '') {\n
	...
	while (list(\$key,\$val) = each(\$aGblSites)) {\n
		...
		fwrite($rOtPageFile, " \n include(\"\$sGblIncludePath/newOtPageInclude.php\");\n");
		fwrite($rOtPageFile, " \n include(\"\$sGblIncludePath/newOtPageOffers.php\");?>\n");
...
// replace the style sheet tag
$sPage2Template = ereg_replace("\[STYLE_SHEET\]", "<LINK rel=\"stylesheet\" href=\"/pageStyles.css\" type=\"text/css\"><SCRIPT LANGUAGE=JavaScript SRC=\"../libs/ajax.js\" TYPE=\"text/javascript\"></script>", $sPage2Template);
...
include(\"\$sGblIncludePath/newOtPageInclude.php\");\n
include(\"\$sGblIncludePath/newOtPage2Offers.php\");\n
...
if ($bOtPagesDir) {
	...
	unlink($sPageName."b_2.php");
	$rOtPage2File = fopen($sPageName."b_2.php", "w");
...
$sE1PageContent = ereg_replace("\[HEADER_GRAPHIC_FILE\]", "$sGblDisplayPageImagesUrl/$sPageName/images/$sE1HeaderGraphicFile", $sE1PageContent);
