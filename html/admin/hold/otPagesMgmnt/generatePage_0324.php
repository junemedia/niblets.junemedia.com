...
/*
$sNewOtPageSubmitFile = "/newOtPageSubmit.php";
$sNewOtPage2SubmitFile = "/newOtPage2Submit.php";
*/
...
$sOtPageContent = ereg_replace("\[STYLE_SHEET\]", "<LINK rel=\"stylesheet\" href=\"/pageStyles.css\" type=\"text/css\">", $sOtPageContent);
...
$sOtPageContent = ereg_replace("\[HEADER_GRAPHIC_FILE\]", "$sGblDisplayPageImagesUrl/$sPageName/images/$sHeaderGraphicFile", $sOtPageContent);
...
// replace header graphic in page layout
	...
	$sPage1Header = "<?php  if (\$header == ''){\n 						
						echo \"".addslashes("<img src=\"$sGblDisplayPageImagesUrl/$sPageName/images/$sHeaderGraphicFile\">")."\";\n}\n
					  else {\n
						
						if (file_exists(\"\$sGblOtPagesPath/$sPageName/headers/\$header.php\")) {\n
						
							include(\"\$sPageName/headers/\$header.php\");\n
						} else {
							echo \"".addslashes("<img src=\"$sGblDisplayPageImagesUrl/$sPageName/images/$sHeaderGraphicFile\">")."\";\n}\n
...
if ( file_exists("$sGblOtPagesPath/$sPageName/images/step0.png")) {
	$sOtPageContent = ereg_replace("\[STEP0_GRAPHIC_FILE\]", "$sGblDisplayPageImagesUrl/$sPageName/images/step0.png", $sOtPageContent);
} else if (file_exists("$sGblOtPagesPath/$sPageName/images/step0.jpg")) {
	$sOtPageContent = ereg_replace("\[STEP0_GRAPHIC_FILE\]", "$sGblDisplayPageImagesUrl/$sPageName/images/step0.jpg", $sOtPageContent);
} else {
	$sOtPageContent = ereg_replace("\[STEP0_GRAPHIC_FILE\]", "$sGblDisplayPageImagesUrl/$sPageName/images/step0.gif", $sOtPageContent);
}

// replace other images in the page
if ( file_exists("$sGblOtPagesPath/$sPageName/images/step1.png")) {
	$sOtPageContent = ereg_replace("\[STEP1_GRAPHIC_FILE\]", "$sGblDisplayPageImagesUrl/$sPageName/images/step1.png", $sOtPageContent);
} else if (file_exists("$sGblOtPagesPath/$sPageName/images/step1.jpg")) {
	$sOtPageContent = ereg_replace("\[STEP1_GRAPHIC_FILE\]", "$sGblDisplayPageImagesUrl/$sPageName/images/step1.jpg", $sOtPageContent);
} else {
	$sOtPageContent = ereg_replace("\[STEP1_GRAPHIC_FILE\]", "$sGblDisplayPageImagesUrl/$sPageName/images/step1.gif", $sOtPageContent);
}

// replace other images in the page
if ( file_exists("$sGblOtPagesPath/$sPageName/images/step2.png")) {
	$sOtPageContent = ereg_replace("\[STEP2_GRAPHIC_FILE\]", "$sGblDisplayPageImagesUrl/$sPageName/images/step2.png", $sOtPageContent);
} else if (file_exists("$sGblOtPagesPath/$sPageName/images/step2.jpg")) {
	$sOtPageContent = ereg_replace("\[STEP2_GRAPHIC_FILE\]", "$sGblDisplayPageImagesUrl/$sPageName/images/step2.jpg", $sOtPageContent);
} else {
	$sOtPageContent = ereg_replace("\[STEP2_GRAPHIC_FILE\]", "$sGblDisplayPageImagesUrl/$sPageName/images/step2.gif", $sOtPageContent);
}

// replace other images in the page
if ( file_exists("$sGblOtPagesPath/$sPageName/images/step3.png")) {
	$sOtPageContent = ereg_replace("\[STEP3_GRAPHIC_FILE\]", "$sGblDisplayPageImagesUrl/$sPageName/images/step3.png", $sOtPageContent);
} else if (file_exists("$sGblOtPagesPath/$sPageName/images/step3.jpg")) {
	$sOtPageContent = ereg_replace("\[STEP3_GRAPHIC_FILE\]", "$sGblDisplayPageImagesUrl/$sPageName/images/step3.jpg", $sOtPageContent);
} else {
	$sOtPageContent = ereg_replace("\[STEP3_GRAPHIC_FILE\]", "$sGblDisplayPageImagesUrl/$sPageName/images/step3.gif", $sOtPageContent);
}

// replace other images in the page
if ( file_exists("$sGblOtPagesPath/$sPageName/images/arrow.png")) {
	$sOtPageContent = ereg_replace("\[ARROW_GRAPHIC_FILE\]", "$sGblDisplayPageImagesUrl/$sPageName/images/arrow.png", $sOtPageContent);
} else if (file_exists("$sGblOtPagesPath/$sPageName/images/arrow.jpg")) {
	$sOtPageContent = ereg_replace("\[ARROW_GRAPHIC_FILE\]", "$sGblDisplayPageImagesUrl/$sPageName/images/arrow.jpg", $sOtPageContent);
} else {
	$sOtPageContent = ereg_replace("\[ARROW_GRAPHIC_FILE\]", "$sGblDisplayPageImagesUrl/$sPageName/images/arrow.gif", $sOtPageContent);
}
...
/*
 $sCheckCookieEnabled = "<script language=JavaScript>\n
 if (document.cookie == '') {\n 	
 	window.location.href=\"$sGblSiteRoot/mustHaveCookies.html\";\n
 }\n
 </script>\n
 </head>";
 $sOtPageContent = eregi_replace("</head>", $sCheckCookieEnabled, $sOtPageContent);
*/
...
if (\$sSiteId != '') {\n
	...
	while (list(\$key,\$val) = each(\$aGblSites)) {\n
		if (\$key == \$sSiteId) {\n
			...
			if (\$sCurrSite != \$aGblSiteNames[\$key]) {\n
...
$sPage2Template = ereg_replace("\[PAGE2_EXTRA_TEXT2\]", $sPage2ExtraText2, $sPage2Template);
	...
	// replace the style sheet tag
	$sPage2Template = ereg_replace("\[STYLE_SHEET\]", "<LINK rel=\"stylesheet\" href=\"/pageStyles.css\" type=\"text/css\">", $sPage2Template);
...
// replace header graphic in page layout
	if ($iDisplayPage2HeaderImage) {
		$sPage2Template = ereg_replace("\[HEADER_GRAPHIC_IMAGE_TAG\]", "<img src='$sGblDisplayPageImagesUrl/$sPageName/images/$sHeaderGraphicFile'>", $sPage2Template);
	} else {
