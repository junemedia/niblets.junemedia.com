...
if ($sShowExitPopup != '' && $sShowExitPopup != 'never') {
	...
	if ($sShowExitPopup =='always') {
	...
	} else if ($sShowExitPopup == 'onlySrc') {



		$sExitPopupScript = "\r\n<script LANGUAGE=\"javascript\">var f=1; <?php\n echo \$_SESSION['sSesPage1JavaScriptVars'];?>\n</script>\r\n
			<script src=\"http://www.popularliving.com/libs/jsPopFuncs.js\"></script>\r\n
		...
		$sExitPopupText = "<body onunload=\"showPopupOnlySrc(f, '$sSrcForExitPopup' )\" ";
