...
$sReportQuery = "SELECT * FROM RecipesDisplay WHERE 1=1 
				$title_filter
				$campbells1_filter
				$campbells2_filter
				$sort_by ";
...
<html>
<head>
<title>Recipe4Living Recipe View Stats - Current Stats</title>
...
<table cellpadding=5 cellspacing=0 bgcolor=	#FFE4B5 width=95% align=center>
	<tr><td colspan=4>
		<b><a href="index.php">Display Older Stats</a></b>
		<br><br>
		<b>Title Search: </b> 
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="submit" name=sSubmit value='View Report'> (Total: <?php echo $iCount; ?>)
		</td>
	</tr>
</table>
</form>
...
<tr><td>Total</td><td colspan="2"><?php echo $iCount; ?></td></tr>
</table>
</body>
</html>
