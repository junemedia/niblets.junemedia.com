...
<table cellpadding=5 cellspacing=0 bgcolor=c9c9c9 width=95% align=center>
	...
	<tr><td colspan=2><input type=submit name=sSubmit value='History Report' onClick="funcReportClicked('history');">  &nbsp; &nbsp; 
	<input type=submit name=sSubmit value="Today's Report" onClick="funcReportClicked('today');">  &nbsp; &nbsp; 
