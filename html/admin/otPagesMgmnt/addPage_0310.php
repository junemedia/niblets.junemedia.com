		...
		if (!($iId)) {
			...
			if (dbNumRows($rCheckResult) == 0) {
				...
				$sAddQuery = "INSERT INTO otPages(id, pageName, title, notes, pageLayoutId, page2LayoutId, newPage2LayoutId, userFormLayoutId, newUserFormLayoutId, offerListLayoutId, e1PageLayoutId, hiddenForm, minNoOfOffers, maxNoOfOffers, displayYesNo, offerImageSize, offerFontSize,
							...
							passOnInboundQueryString, inboundVarMap, outboundVarMap, passOnPhpsessid, enableGoTo, isGoToPopUp, offersByPageMap, offersByCatMap, autoEmail, autoEmailSub,
							autoEmailText, autoEmailFromAddr, isCobrand, displayPoweredBy, offerNotRequired, optOut, sureOptOut, sureOptOutText, noThankYouCode,
