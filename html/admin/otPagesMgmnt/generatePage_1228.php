...
if ( file_exists("$sGblWebRoot/p/$sPageName/images/step0.png")) {
	$sOtPageContent = ereg_replace("\[STEP0_GRAPHIC_FILE\]", "/p/$sPageName/images/step0.png", $sOtPageContent);
} else if (file_exists("$sGblWebRoot/p/$sPageName/images/step0.jpg")) {
	$sOtPageContent = ereg_replace("\[STEP0_GRAPHIC_FILE\]", "/p/$sPageName/images/step0.jpg", $sOtPageContent);
} else {
	$sOtPageContent = ereg_replace("\[STEP0_GRAPHIC_FILE\]", "/p/$sPageName/images/step0.gif", $sOtPageContent);
}

// replace other images in the page
if ( file_exists("$sGblWebRoot/p/$sPageName/images/step1.png")) {
	$sOtPageContent = ereg_replace("\[STEP1_GRAPHIC_FILE\]", "/p/$sPageName/images/step1.png", $sOtPageContent);
} else if (file_exists("$sGblWebRoot/p/$sPageName/images/step1.jpg")) {
	$sOtPageContent = ereg_replace("\[STEP1_GRAPHIC_FILE\]", "/p/$sPageName/images/step1.jpg", $sOtPageContent);
} else {
	$sOtPageContent = ereg_replace("\[STEP1_GRAPHIC_FILE\]", "/p/$sPageName/images/step1.gif", $sOtPageContent);
}

// replace other images in the page
if ( file_exists("$sGblWebRoot/p/$sPageName/images/step2.png")) {
	$sOtPageContent = ereg_replace("\[STEP2_GRAPHIC_FILE\]", "/p/$sPageName/images/step2.png", $sOtPageContent);
} else if (file_exists("$sGblWebRoot/p/$sPageName/images/step2.jpg")) {
	$sOtPageContent = ereg_replace("\[STEP2_GRAPHIC_FILE\]", "/p/$sPageName/images/step2.jpg", $sOtPageContent);
} else {
	$sOtPageContent = ereg_replace("\[STEP2_GRAPHIC_FILE\]", "/p/$sPageName/images/step2.gif", $sOtPageContent);
}

// replace other images in the page
if ( file_exists("$sGblWebRoot/p/$sPageName/images/step3.png")) {
	$sOtPageContent = ereg_replace("\[STEP3_GRAPHIC_FILE\]", "/p/$sPageName/images/step3.png", $sOtPageContent);
} else if (file_exists("$sGblWebRoot/p/$sPageName/images/step3.jpg")) {
	$sOtPageContent = ereg_replace("\[STEP3_GRAPHIC_FILE\]", "/p/$sPageName/images/step3.jpg", $sOtPageContent);
} else {
	$sOtPageContent = ereg_replace("\[STEP3_GRAPHIC_FILE\]", "/p/$sPageName/images/step3.gif", $sOtPageContent);
}

// replace other images in the page
if ( file_exists("$sGblWebRoot/p/$sPageName/images/arrow.png")) {
	$sOtPageContent = ereg_replace("\[ARROW_GRAPHIC_FILE\]", "/p/$sPageName/images/arrow.png", $sOtPageContent);
} else if (file_exists("$sGblWebRoot/p/$sPageName/images/arrow.jpg")) {
	$sOtPageContent = ereg_replace("\[ARROW_GRAPHIC_FILE\]", "/p/$sPageName/images/arrow.jpg", $sOtPageContent);
} else {
	$sOtPageContent = ereg_replace("\[ARROW_GRAPHIC_FILE\]", "/p/$sPageName/images/arrow.gif", $sOtPageContent);
}
...
$sE1PageContent = ereg_replace("\[HEADER_GRAPHIC_FILE\]", "/p/$sPageName/images/$sE1HeaderGraphicFile", $sE1PageContent);
