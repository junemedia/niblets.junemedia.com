...
$sPageTitle = "Nibbles Stickers And Slogans Management - Add/Edit Sticker/Slogan";
...
if (($sSaveClose || $sSaveNew) && !($id)) {
	...
	if (checkDate($activeMonth, $activeDay, $activeYear) && checkDate($inactiveMonth, $inactiveDay, $inactiveYear)) {
		...
		$addQuery = "INSERT INTO edStickersAndSlogans(headline, description, activeDate, inactiveDate, dateInserted, frontPageDisplay)
					 VALUES(\"$headline\", \"$description\", '$activeDate', '$inactiveDate', CURRENT_DATE, '$frontPageDisplay')";
