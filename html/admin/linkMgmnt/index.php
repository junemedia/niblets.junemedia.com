...
if (hasAccessRight($iMenuId) || isAdmin()) {
	if ($sSave) {
		$sDeleteEntry = "DELETE FROM nibbles_r4l.myfree_pages
					WHERE page = 'links.php'";
		$rDeleteResult = dbQuery($sDeleteEntry);
		$sContent = addslashes($sContent);
		$sInsertHelp = "INSERT INTO nibbles_r4l.myfree_pages (content, page) VALUES (\"$sContent\",'links.php')";
...
<tr><Td align=left valign=top>MyFree Links Page Content:</a></th>
...
<tr align="center"><td colspan="2"><iframe src="http://www.myfree.com/links.php" width="950px" frameborder="0" height="800px"></td></tr>
</table>
<?php
