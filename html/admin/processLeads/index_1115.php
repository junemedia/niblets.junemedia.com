...
<table cellpadding=3 cellspacing=0 bgcolor=c9c9c9 width=95% align=center>
	<tr><td colspan=2 class=header><?php echo $sSetLeadsBackLink;?> &nbsp; &nbsp; <?php echo $sRealTimePostLink;?></td><td></tr>
	...
	<tr><td><b>Step 2:</b> </td><td><input type=file name='fImportFile'> &nbsp; <input type=submit name=sImportData value='Import Postal Verified Data'></td></tr>
	<tr><td colspan=2><BR><BR></td></tr>
	<tr><td><b>Step 3:</b> </td>
	...
	<tr><td><b>Step 5:</b> </td><td><input type=submit name=sProcessLeads value='Process Leads'> &nbsp; &nbsp; &nbsp; <input type=checkbox name=sUseCurrentTable value='Y' <?php echo $sUseCurrentTableChecked;?>> Use Current Table</td></tr>		
	<tr><td><b>Step 6:</b> </td><td><input type=submit name=sSendLeads value='Send Leads Out'>		
		&nbsp; Test Mode <input type=checkbox name=sTestMode value="1" <?php echo $sTestModeChecked;?>>
		...
		<BR><BR><input type=submit name=sSendFormPostLeads value='Send Form Post Leads Out'>
		</td></tr>
